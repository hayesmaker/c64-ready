...
- Merge pull request #191 from hayesmaker/feature/cheat-menu (d6285f1)
- feat: qol features for integrating cheevos (a4abc78)
- Merge pull request #189 from hayesmaker/feat/cheevos-dev (07547ea)
- fix(cheevos): resolve package from npm registry (a44c191)
- chore: regenerated lockfile (bdb1005)
- chore: import published cheevos (f31df4b)

## v3.0.0 - 2026-09-20T17:53:22+01:00

## What's Changed
* fix: split disk load mount and autoload by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/162
* chore: update CHANGELOG.md (auto) by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/163
* fixes and features to attract mode demo player by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/164
* feat: keyboard remap api by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/166
* chore: update CHANGELOG.md (auto) by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/165
* Release/2.5.0 by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/167
* feat: added attract mode chat commands support by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/168
* Feat/attract mode chat commands by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/170
* fix(headless): ack attract mode before disk fetch by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/172
* fix(headless): ack attract mode before reboot by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/174
* Fix/attract mode admin timeout by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/176
* fix: attractMode off command persisting by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/178
* feat: added support for c64cade's public api by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/180
* feat: whep endpoint support by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/182
* chore(release): 3.0.0-rc.0 by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/184
* feat(headless): require admin token for host controls by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/185
* fix: update spectator count properly by @hayesmaker in https://github.com/hayesmaker/c64-ready/pull/187


**Full Changelog**: https://github.com/hayesmaker/c64-ready/compare/v2.4.0...v3.0.0

## v2.4.0 - 2026-06-21T13:51:38+01:00

- chore(release): 2.4.0 (1915b20)
